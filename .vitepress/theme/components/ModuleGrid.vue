...
const modules = [
  {
    ...
    link: '/networking/',
    topics: [
      { icon: Network, text: 'Pengantar Jaringan', link: '/networking/' },
      { icon: Layers, text: 'Model OSI', link: '/networking/model-osi' },
      { icon: ArrowLeftRight, text: 'Model TCP/IP', link: '/networking/model-tcp-ip' },
      ...
      { icon: BrickWall, text: 'Firewall — Panduan Lengkap', link: '/networking/firewall' },
      { icon: ShieldAlert, text: 'Keamanan Lanjutan', link: '/networking/keamanan-lanjut' },
    ],
  },
  {
    code: 'MODUL 02',
    ...
    topics: [
      ...
      { icon: Calculator, text: 'Simulasi Link Budget', link: '/satelit/link-budget' },
      { icon: Scale, text: 'LEO vs VSAT vs Starlink', link: '/satelit/leo-vsat-starlink' },
      { icon: SatelliteDish, text: 'VSAT', link: '/satelit/vsat' },
      { icon: ClipboardList, text: 'VSAT — Operasional & Perencanaan', link: '/satelit/vsat-lanjut' },
    ],
  },
  {
    code: 'MODUL 03',
    ...
    link: '/mikrotik/',
    topics: [
      { icon: BookOpen, text: 'Pengantar RouterOS', link: '/mikrotik/' },
      { icon: KeyRound, text: 'Akses Awal', link: '/mikrotik/akses-awal' },
      { icon: Settings, text: 'Manajemen Perangkat', link: '/mikrotik/manajemen' },
      { icon: EthernetPort, text: 'Interface & IP Address', link: '/mikrotik/interface-ip' },
      { icon: Globe, text: 'IPv6 di RouterOS', link: '/mikrotik/ipv6' },
      { icon: Split, text: 'Bridging & Switching', link: '/mikrotik/bridging-switching' },
      { icon: ArrowLeftRight, text: 'DHCP, DNS & NAT', link: '/mikrotik/dhcp-dns-nat' },
      { icon: Route, text: 'Routing di RouterOS', link: '/mikrotik/routing' },
      { icon: BrickWall, text: 'Firewall & QoS', link: '/mikrotik/firewall-qos' },
      { icon: Cable, text: 'PPPoE', link: '/mikrotik/pppoe' },
      { icon: Lock, text: 'VPN', link: '/mikrotik/vpn' },
      { icon: Wifi, text: 'Wireless & Satelit', link: '/mikrotik/wireless-dan-satelit' },
      { icon: Shuffle, text: 'Failover & Multi-WAN Satelit', link: '/mikrotik/multi-wan' },
      { icon: Gauge, text: 'Optimasi VPN & MTU/MSS', link: '/mikrotik/vpn-optimization' },
      { icon: Sliders, text: 'QoS Dinamis', link: '/mikrotik/dynamic-qos' },
      { icon: Activity, text: 'Operasi & Monitoring', link: '/mikrotik/monitoring' },
      { icon: Terminal, text: 'Scripting & Otomatisasi', link: '/mikrotik/scripting-otomatisasi' },
      { icon: BookMarked, text: 'Glosari', link: '/mikrotik/glosari' },
    ],
  },
  {
    code: 'MODUL 04',
    ...
    topics: [
      ...
      { icon: Cpu, text: 'Perangkat Keras', link: '/starlink/hardware' },
      { icon: Package, text: 'Jenis Layanan & Paket', link: '/starlink/layanan' },
      { icon: Sliders, text: 'Praktik Integrasi RouterOS', link: '/starlink/praktik-mikrotik' },
